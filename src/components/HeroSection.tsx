...
import { Mail, Phone, MapPin, Download, ChevronDown, Sparkles, Instagram, Facebook, Linkedin, Twitter, Github } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
                ...
                <span className="relative inline-block mt-2">
                  ...
                  <span className="relative gradient-text">{personal.name}</span>
                </span>
              </h1>
            </motion.div>
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm text-muted-foreground text-sm border border-white/10 hover:bg-white/10 hover:border-primary/30 transition-all duration-300"
              >
            ...
            >
              {socialLinks?.twitter && (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 hover:bg-white/10 transition-all duration-300"
                >
                  <Twitter size={18} />
                </a>
              )}
          ...
          >
            <div className="relative">
              ...
              {/* Image Container */}
              <motion.div
                className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-2 border-white/10 shadow-2xl"
                animate={{ y: [0, -10, 0] }}
